<head>
  ...
  <style>
    ...
    .section {
      ...
      padding: 20px;
      margin-bottom: 20px;
      box-shadow: 0 2px 3px rgba(255,0,0);
    }
    footer {
      background: #000000;
      color: white;
...
<body>
  ...
  </div>  <!-- Optional -->  <div class="section">
  ...
  </div>  <!-- Freelancing -->  <div class="section">
  ...
  </div>  <!-- Resources -->  <div class="section">
  ...
  </div>  <!-- Final Outcome -->  <div class="section">
    <h2>🏁 Final Outcome</h2>
    <ul>
